...
3. **Spawn prompts**: do not copy `producer-contract.md` — point reviewers at it in place (`<grumpy-review skill dir>/references/producer-contract.md`). Put this verbatim in every spawn prompt:
